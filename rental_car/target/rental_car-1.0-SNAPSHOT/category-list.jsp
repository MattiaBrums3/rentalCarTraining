                                    ...
                                    <tbody>
                                        <c:forEach var="category" items="${listCategories}">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a href="editCategory?id=<c:out value='${category.id}' />"><input type="button" class="btnTable" value="Modifica" /></a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="deleteCategory?id=<c:out value='${category.id}' />"><input type="button" class="btnTable" value="Elimina" /></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>
