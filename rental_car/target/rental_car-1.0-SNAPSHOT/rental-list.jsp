                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            <c:if test="${rental.approved == false}">
                                                                <a href="approveRental?approved=true&id=<c:out value='${rental.id}' />"><input type="button" class="btnTable" value="Accetta" /></a>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                <a href="approveRental?approved=false&id=<c:out value='${rental.id}' />"><input type="button" class="btnTable" value="Rifiuta" /></a>
                                                            </c:if>
